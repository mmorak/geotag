...
public class SettingsDialog extends JDialog {
  ...
  public SettingsDialog(JFrame parent) {
    super(parent, Messages.getString("SettingsDialog.Settings"), true); // true == modal //$NON-NLS-1$
    this.parent = parent;
    ...
    panelList.add(new SettingsPanel(Messages.getString("SettingsDialog.ExiftoolPath"),Settings.EXIFTOOL_PATH,"exiftool",SettingsPanel.FILE)); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    okButton.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent e) {
        for (SettingsPanel settingsPanel : panelList) {
          ...
          if (! value.equals(Settings.get(setting, settingsPanel.getDefaultValue()))) {
