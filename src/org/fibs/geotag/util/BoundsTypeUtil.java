...
public class BoundsTypeUtil {
   ...
   * @param mapHeight in pixels
   * @return the distance in pixels the points would have on (or off) the map
   */
  public static double pixelDistance(Trkpt point1, Trkpt point2, BoundsType mapBounds, int mapWidth, int mapHeight) {
